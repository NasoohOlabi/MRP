export const en = {
    ...
    help_overview: "I help with students, teachers, and attendance. Tell me what you need or tap a command.",
    help_examples: "Examples: \"Add a student\", \"Take attendance\", \"View student info\".",
    enter_first_name: "Enter first name:",
    enter_last_name: "Enter last name:",
    enter_birth_year: "Enter birth year (YYYY):",
    enter_group: "Enter group:",
    enter_teacher_name: "Enter teacher name:",
    enter_teacher_name_search: "Enter the teacher name to search:",
    enter_teacher_new_name: "Enter new teacher name (or '-' to keep current):",
    ...
    enter_event_name_or_date: "Enter event name (or /today for today\'s date):",
    default_event_name: "Attendance",
    enter_date: "Enter date (YYYY-MM-DD) or /today:",
